...
В состав проекта включены следующие компоненты, распределенные по слоям:
1. Web Interface - слой взаимодействия с пользователями: веб интерфейс
2. APi calls - слой взаимодействия с сервисами: набор вызовов Rest API
3. Calculate service - сервисный слой: сервис распределенных вычислений
4. Data Storage - слой хранения данных: база данных для хранения информации о пользователях и вычислениях.
...
База данных реализована на базе реалиционной СУБД SQLlite. Структура базы данных проекта включает две таблиц: 

    - users - хранение информации о пользователе
    - expressions - хранение информации о вычисленных пользователем выражениях
